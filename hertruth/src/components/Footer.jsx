import she from "../images/FOR.png"
import React from 'react'

const Footer = () => {
  return <>
    <footer className=" relative z-10 bg-black bg-opacity-20 pt-8 pb-10 lg:pt-[80px] border-t-2 border-gray-500 flex-col flex items-center justify-center">
